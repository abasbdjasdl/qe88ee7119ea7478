...
registry_value() {
    ( bounded 3 /usr/sbin/ioreg -r -c R16RTL8852BE -a -l -d 2 2>/dev/null
...
if [ "$test_id" = NETWORK-START-02 ] && [ -z "$second_id" ]; then
    ...
    for key in R16NetworkStage R16NetworkStartFailed R16ProbeStage R16ProbeError R16ProbePciError R16ProbePowerError R16ProbePowerAddress R16ProbePowerExpected R16ProbePowerActual R16ProbePowerReads R16ProbePowerWrites R16ProbeDownloadStatus R16ProbePollAddress R16ProbePollMask R16ProbePollWanted R16ProbePollActual R16MacStage R16MacError R16MacAddress R16MacExpected R16MacActual R16PrepStage R16PrepError R16PrepAddress R16PrepWanted R16PrepActual R16FwOperation R16FwPhase R16FwFailedPhase R16FwControl R16FwIndex R16FwQuiesced R16FwReleased R16FwRetained R16BankStatus R16BankSlot R16DmaAddress R16DmaExpected R16DmaActual R16DmaBusy R16DmaPolls R16DmaMasked R16DmaMasterOff R16DmaIdle R16DmaStopped R16RadioPhase R16RadioStage R16RadioStep R16RadioError R16RadioCommandError R16RadioCommandsUsed R16RadioUploadPath R16RadioUploadPage R16BtInitStage R16BtInitError R16BtInitAddress R16BtLeaseStage R16BtLeaseError R16BtLeaseAddress R16BtLeaseHeld R16BtLeaseConsumed R16BtLeaseEnded R16RfkNativeLease R16RfkStage R16RfkError R16RfkSpace R16RfkPath R16RfkAddress R16RfkMask R16RfkValue R16RfkOperations R16RfkPolls R16PhyStage R16PhyError R16PhyAddress R16PhyExpected R16PhyActual R16ChannelStage R16ChannelError R16ChannelAddress R16RadioIoStatus R16RadioSnapshotComplete R16BtInitValue R16BtInitRfPath R16BtInitRfAddress R16BtInitRfExpected R16BtInitOperations R16BtInitPolls R16BtInitRadioStatus R16BtRfReadAddress R16BtRfReadValue R16BtRfWriteAddress R16BtRfWriteValue R16BtRfWriteCommand R16LiveCommands R16LiveCommandError R16LiveStation R16LiveProtocol R16LiveEnabled R16LiveFaulted R16LiveBootReady R16LiveTraffic R16LiveAction R16LiveActionPending R16LiveBsdNamed R16LiveTxSubmitted R16LiveRxComplete R16LiveRxWireless R16LiveRxPhy R16LiveRxDeliveryAttempts R16LiveRxGated R16TraceRequestInit R16TraceRequestScan R16TraceRequestAuth R16TraceRequestAssoc R16TraceRequestRun R16TraceLastRequest R16TraceRunCommitted R16TracePortAuthorizations R16TraceRxBridgeOk R16TraceRxBridgeError R16TraceRxLastError R16TraceTxPrepareErrors R16TraceTxLastError R16TraceStationError R16TraceSupplicant R16TracePortValid R16TraceRsnEnabled R16TraceActionDeferred R16TraceDataDrained R16TracePendingTx R16TraceEapolKey R16TraceEapolReplay R16TraceEapolBadMic R16TraceDeauth R16TraceDisassoc R16TraceRxNotAssoc R16TraceRxWrongBss R16TraceRxDuplicate R16TraceRxUnauth R16TraceTxNoAuth R16TraceRxUnencrypted R16TraceRxDecap R16TraceCcmpDecrypt R16TraceCcmpReplay R16TraceRxMgmtDiscard R16TraceRxManagement R16TraceRxControl R16TraceRxData R16TraceRxOther R16TraceRxHardwareCrypto R16TraceRxSoftwareFallback R16TraceEapolSeen R16TraceEapolGated R16TraceEapolBridge R16TraceDeauthReason R16TraceEapolBridgeOk R16TraceEapolBridgeFailed R16TraceEapolStage R16TraceEapolError R16TraceEapolLengths R16TraceEapolHeader R16TraceEapolEnvelope R16TraceEapolDropMask R16NativeScanObserver R16NativeScanPassOpen R16NativeScanComplete R16NativeScanGeneration R16NativeScanEpoch R16NativeScanCount R16NativeScanChannels; do
