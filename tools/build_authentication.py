#!/usr/bin/env python3
"""Build/test the userspace SAE component. Does not load a driver or enable SAE."""
...
sources=[upstream/'src'/n for n in names]+[root/'src/auth/SaeSession.c',root/'tests/auth_sae_exchange_test.c']
flags=['-std=gnu11','-g','-O1','-fsanitize=address,undefined','-fno-omit-frame-pointer',
       '-DCONFIG_SAE','-DCONFIG_ECC','-DCONFIG_SHA256','-DCONFIG_SHA384','-DCONFIG_SHA512',
